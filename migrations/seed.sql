...
-- Clean old products, i18n, media, aliases
...
INSERT OR REPLACE INTO product_i18n (product_id, lang, name, category_label, description, sizes, specs) VALUES ('stul-vertex', 'ru', 'Стул «Vertex»', 'Плетёные стулья', 'Плетёный стул Vertex с каркасом из металла и плетением из кручёного искусственного ротанга. Комплектуется мягкой текстильной подушкой. Отлично подходит для дома, веранды, террасы и ресторанов.', '["57 × 63 × 75 см"]', '{"mat":"металл, кручёный искусственный ротанг, текстиль","dim":"57 × 63 × 75 см","maxLoad":"","colors":"Бежевый"}');
INSERT OR REPLACE INTO product_i18n (product_id, lang, name, category_label, description, sizes, specs) VALUES ('stul-vertex', 'uz', '«Vertex» stuli', 'To‘qilgan stullar', 'Metall karkasli va burma sun’iy rotangdan to‘qilgan Vertex stuli. Yumshoq to‘qimachilik yostig‘i bilan jihozlangan. Uy, ayvon, terrasa va restoranlar uchun ajoyib tanlov.', '["57 × 63 × 75 см"]', '{"mat":"металл, кручёный искусственный ротанг, текстиль","dim":"57 × 63 × 75 см","maxLoad":"","colors":"Bej"}');
INSERT OR REPLACE INTO product_i18n (product_id, lang, name, category_label, description, sizes, specs) VALUES ('stul-vertex', 'en', 'Vertex Chair', 'Wicker chairs', 'Vertex wicker chair featuring a sturdy metal frame and twisted synthetic rattan weave. Comes with a soft textile cushion. Ideal for homes, covered patios, terraces, and dining venues.', '["57 × 63 × 75 см"]', '{"mat":"металл, кручёный искусственный ротанг, текстиль","dim":"57 × 63 × 75 см","maxLoad":"","colors":"Beige"}');
...
INSERT OR REPLACE INTO product_i18n (product_id, lang, name, category_label, description, sizes, specs) VALUES ('stul-corda', 'ru', 'Стул «Corda»', 'Плетёные стулья', 'Стул Corda на прочном металлическом каркасе с плотным плетением из искусственного ротанга и мягкой текстильной подушкой. Сочетает комфортную посадку и долговечность.', '["57 × 63 × 77 см"]', '{"mat":"металл, искусственный ротанг, текстиль","dim":"57 × 63 × 77 см","maxLoad":"","colors":""}');
INSERT OR REPLACE INTO product_i18n (product_id, lang, name, category_label, description, sizes, specs) VALUES ('stul-corda', 'uz', '«Corda» stuli', 'To‘qilgan stullar', 'Mustahkam metall karkas va zich sun’iy rotang to‘quviga ega Corda stuli. Yumshoq mato yostiq bilan to‘ldirilgan, qulay o‘tirish va mustahkamlikni ta’minlaydi.', '["57 × 63 × 77 см"]', '{"mat":"металл, искусственный ротанг, текстиль","dim":"57 × 63 × 77 см","maxLoad":"","colors":""}');
INSERT OR REPLACE INTO product_i18n (product_id, lang, name, category_label, description, sizes, specs) VALUES ('stul-corda', 'en', 'Corda Chair', 'Wicker chairs', 'Corda chair on a solid metal frame with dense synthetic rattan weave and textile cushion. Delivers ergonomic comfort and stylish durability.', '["57 × 63 × 77 см"]', '{"mat":"металл, искусственный ротанг, текстиль","dim":"57 × 63 × 77 см","maxLoad":"","colors":""}');
...
INSERT OR REPLACE INTO product_i18n (product_id, lang, name, category_label, description, sizes, specs) VALUES ('stul-roero', 'ru', 'Стул «ROERO»', 'Пластиковые стулья', 'Лёгкий и практичный стул ROERO из прочного износостойкого пластика. Легко очищается влажной салфеткой и удобен в хранении.', '["74 × 46 × 48 см"]', '{"mat":"пластик","dim":"74 × 46 × 48 см","maxLoad":"","colors":"Серый"}');
INSERT OR REPLACE INTO product_i18n (product_id, lang, name, category_label, description, sizes, specs) VALUES ('stul-roero', 'uz', '«ROERO» stuli', 'Plastik stullar', 'Pishiq va yengil ROERO plastik stuli. Tozalash oson va saqlash uchun juda qulay.', '["74 × 46 × 48 см"]', '{"mat":"пластик","dim":"74 × 46 × 48 см","maxLoad":"","colors":"Kulrang"}');
INSERT OR REPLACE INTO product_i18n (product_id, lang, name, category_label, description, sizes, specs) VALUES ('stul-roero', 'en', 'ROERO Chair', 'Plastic chairs', 'Lightweight and practical ROERO plastic chair. Easy to clean and convenient to store.', '["74 × 46 × 48 см"]', '{"mat":"пластик","dim":"74 × 46 × 48 см","maxLoad":"","colors":"Grey"}');
...
INSERT OR REPLACE INTO product_i18n (product_id, lang, name, category_label, description, sizes, specs) VALUES ('stul-noero', 'ru', 'Стул «NOERO»', 'Пластиковые стулья', 'Эргономичный пластиковый стул NOERO с удобной спинкой высотой 82 см. Стильный тёплый оттенок капучино прекрасно дополняет современные интерьеры.', '["82 × 48 × 49 см"]', '{"mat":"пластик","dim":"82 × 48 × 49 см","maxLoad":"","colors":"Капучино"}');
INSERT OR REPLACE INTO product_i18n (product_id, lang, name, category_label, description, sizes, specs) VALUES ('stul-noero', 'uz', '«NOERO» stuli', 'Plastik stullar', '82 sm balandlikdagi qulay suyanchiqqa ega ergonomik NOERO stuli. Chiroyli kapuchino rangi har qanday zamonaviy muhitga mos tushadi.', '["82 × 48 × 49 см"]', '{"mat":"пластик","dim":"82 × 48 × 49 см","maxLoad":"","colors":"Kapuchino"}');
INSERT OR REPLACE INTO product_i18n (product_id, lang, name, category_label, description, sizes, specs) VALUES ('stul-noero', 'en', 'NOERO Chair', 'Plastic chairs', 'Ergonomic NOERO plastic chair with an 82 cm supportive backrest. Modern cappuccino hue fits various interior and terrace settings.', '["82 × 48 × 49 см"]', '{"mat":"пластик","dim":"82 × 48 × 49 см","maxLoad":"","colors":"Cappuccino"}');
...
INSERT OR REPLACE INTO product_i18n (product_id, lang, name, category_label, description, sizes, specs) VALUES ('stul-todo', 'ru', 'Стул «TODO»', 'Пластиковые стулья', 'Пластиковый стул TODO с лаконичной геометрией сиденья и устойчивой конструкцией. Подходит для террас, дома и общественных зон.', '["80 × 51 × 51 см"]', '{"mat":"пластик","dim":"80 × 51 × 51 см","maxLoad":"","colors":"Чёрный"}');
INSERT OR REPLACE INTO product_i18n (product_id, lang, name, category_label, description, sizes, specs) VALUES ('stul-todo', 'uz', '«TODO» stuli', 'Plastik stullar', 'Aniq geometriya va barqaror tuzilishga ega TODO plastik stuli. Terrasa, xonadon va jamoat joylari uchun mos keladi.', '["80 × 51 × 51 см"]', '{"mat":"пластик","dim":"80 × 51 × 51 см","maxLoad":"","colors":"Qora"}');
INSERT OR REPLACE INTO product_i18n (product_id, lang, name, category_label, description, sizes, specs) VALUES ('stul-todo', 'en', 'TODO Chair', 'Plastic chairs', 'TODO plastic chair featuring clean geometry and a stable construction. Suitable for terraces, homes and high-traffic venues.', '["80 × 51 × 51 см"]', '{"mat":"пластик","dim":"80 × 51 × 51 см","maxLoad":"","colors":"Black"}');
...
INSERT OR REPLACE INTO product_i18n (product_id, lang, name, category_label, description, sizes, specs) VALUES ('stul-jardin', 'ru', 'Стул «JARDIN»', 'Пластиковые стулья', 'Комфортное пластиковое кресло-стул JARDIN с широким сиденьем и подлокотниками. Практичное решение для отдыха в саду и на веранде.', '["73.5 × 53.5 × 55.5 см"]', '{"mat":"пластик","dim":"73.5 × 53.5 × 55.5 см","maxLoad":"","colors":"Капучино"}');
INSERT OR REPLACE INTO product_i18n (product_id, lang, name, category_label, description, sizes, specs) VALUES ('stul-jardin', 'uz', '«JARDIN» stuli', 'Plastik stullar', 'Keng o‘rindiq va tirsak suyanchig‘iga ega JARDIN plastik kreslo-stuli. Bog‘ va ayvonda hordiq chiqarish uchun qulay yechim.', '["73.5 × 53.5 × 55.5 см"]', '{"mat":"пластик","dim":"73.5 × 53.5 × 55.5 см","maxLoad":"","colors":"Kapuchino"}');
INSERT OR REPLACE INTO product_i18n (product_id, lang, name, category_label, description, sizes, specs) VALUES ('stul-jardin', 'en', 'JARDIN Chair', 'Plastic chairs', 'Comfortable JARDIN plastic armchair featuring wide seating and integrated armrests. Practical choice for garden relaxation and patio dining.', '["73.5 × 53.5 × 55.5 см"]', '{"mat":"пластик","dim":"73.5 × 53.5 × 55.5 см","maxLoad":"","colors":"Cappuccino"}');
...
INSERT OR REPLACE INTO product_i18n (product_id, lang, name, category_label, description, sizes, specs) VALUES ('stul-lira', 'ru', 'Стул «LIRA»', 'Мягкие стулья', 'Элегантный стул LIRA с мягким сиденьем и высокой спинкой 95 см на прочном металлическом каркасе. Прекрасный выбор для обеденной зоны в квартире или загородном доме.', '["95 × 55 × 48 см"]', '{"mat":"металл, текстиль","dim":"95 × 55 × 48 см","maxLoad":"","colors":""}');
INSERT OR REPLACE INTO product_i18n (product_id, lang, name, category_label, description, sizes, specs) VALUES ('stul-lira', 'uz', '«LIRA» stuli', 'Yumshoq stullar', 'Mustahkam metall karkasdagi yumshoq o‘rindiq va 95 sm baland suyanchiqqa ega nafis LIRA stuli. Oshxona va mehmonxona ovqatlanish hududi uchun ajoyib tanlov.', '["95 × 55 × 48 см"]', '{"mat":"металл, текстиль","dim":"95 × 55 × 48 см","maxLoad":"","colors":""}');
INSERT OR REPLACE INTO product_i18n (product_id, lang, name, category_label, description, sizes, specs) VALUES ('stul-lira', 'en', 'LIRA Chair', 'Upholstered chairs', 'Elegant LIRA chair featuring soft upholstery and a high 95 cm backrest on a sturdy metal frame. An attractive fit for home dining rooms and banquet spaces.', '["95 × 55 × 48 см"]', '{"mat":"металл, текстиль","dim":"95 × 55 × 48 см","maxLoad":"","colors":""}');
...
INSERT OR REPLACE INTO product_i18n (product_id, lang, name, category_label, description, sizes, specs) VALUES ('kreslo-como', 'ru', 'Кресло «COMO»', 'Мягкие стулья', 'Мягкое кресло COMO с глубокой посадкой, металлическим каркасом и приятной текстильной обивкой. Создаёт уютную атмосферу для отдыха и долгих бесед.', '["82 × 63 × 60 см"]', '{"mat":"металл, текстиль","dim":"82 × 63 × 60 см","maxLoad":"","colors":""}');
INSERT OR REPLACE INTO product_i18n (product_id, lang, name, category_label, description, sizes, specs) VALUES ('kreslo-como', 'uz', '«COMO» kreslosi', 'Yumshoq stullar', 'Chuqur o‘rindiqli, metall karkasli va yoqimli matoli COMO yumshoq kreslosi. Dam olish va suhbatlar uchun shinam muhit yaratadi.', '["82 × 63 × 60 см"]', '{"mat":"металл, текстиль","dim":"82 × 63 × 60 см","maxLoad":"","colors":""}');
INSERT OR REPLACE INTO product_i18n (product_id, lang, name, category_label, description, sizes, specs) VALUES ('kreslo-como', 'en', 'COMO Armchair', 'Upholstered chairs', 'COMO upholstered lounge armchair with a deep seat profile, metal frame, and comfortable textile padding. Brings relaxed elegance to any lounge or living room.', '["82 × 63 × 60 см"]', '{"mat":"металл, текстиль","dim":"82 × 63 × 60 см","maxLoad":"","colors":""}');
...
INSERT OR REPLACE INTO product_i18n (product_id, lang, name, category_label, description, sizes, specs) VALUES ('stol-taper-rotang-80', 'ru', 'Стол «Taper Rotang 80x80»', 'Столы', 'Компактный квадратный стол Taper Rotang 80×80 см. Каркас из металла с декоративной отделкой из искусственного ротанга и столешницей из ЛДСП. Для помещений и крытых пространств. Столешницу из ЛДСП рекомендуется защищать от прямых осадков.', '["80 × 80 × 75 см"]', '{"mat":"ЛДСП, металл, искусственный ротанг","dim":"80 × 80 × 75 см","maxLoad":"","colors":""}');
INSERT OR REPLACE INTO product_i18n (product_id, lang, name, category_label, description, sizes, specs) VALUES ('stol-taper-rotang-80', 'uz', '«Taper Rotang 80x80» stoli', 'Stollar', 'Ixcham kvadrat Taper Rotang 80×80 sm stoli. Metall karkas, sun’iy rotang bezagi va LDSP ustki qismi. Xonalar va yopiq maydonlar uchun. LDSP ustki qismini to‘g‘ridan-to‘g‘ri yog‘ingarchilikdan himoya qilish tavsiya etiladi.', '["80 × 80 × 75 см"]', '{"mat":"ЛДСП, металл, искусственный ротанг","dim":"80 × 80 × 75 см","maxLoad":"","colors":""}');
INSERT OR REPLACE INTO product_i18n (product_id, lang, name, category_label, description, sizes, specs) VALUES ('stol-taper-rotang-80', 'en', 'Taper Rotang 80x80 Table', 'Tables', 'Compact square table Taper Rotang 80×80 cm. Metal frame accented with synthetic rattan and durable chipboard tabletop. For indoor and covered spaces. It is recommended to protect the chipboard tabletop from direct precipitation.', '["80 × 80 × 75 см"]', '{"mat":"ЛДСП, металл, искусственный ротанг","dim":"80 × 80 × 75 см","maxLoad":"","colors":""}');
...
INSERT OR REPLACE INTO product_i18n (product_id, lang, name, category_label, description, sizes, specs) VALUES ('stol-vertex-d90', 'ru', 'Стол «Vertex D90»', 'Столы', 'Круглый обеденный стол Vertex диаметром 90 см со столешницей цвета белый мрамор и металлическим основанием. Для помещений и крытых пространств. Столешницу из ЛДСП рекомендуется защищать от прямых осадков.', '["Ø90 × 75 см"]', '{"mat":"ЛДСП, металл","dim":"Ø90 × 75 см","maxLoad":"","colors":"Белый мрамор"}');
INSERT OR REPLACE INTO product_i18n (product_id, lang, name, category_label, description, sizes, specs) VALUES ('stol-vertex-d90', 'uz', '«Vertex D90» stoli', 'Stollar', 'Oq marmar teksturali LDSP ustki qismi va metall asosga ega 90 sm diametrli dumaloq Vertex stuli. Xonalar va yopiq maydonlar uchun. LDSP ustki qismini to‘g‘ridan-to‘g‘ri yog‘ingarchilikdan himoya qilish tavsiya etiladi.', '["Ø90 × 75 см"]', '{"mat":"ЛДСП, металл","dim":"Ø90 × 75 см","maxLoad":"","colors":"Oq marmar"}');
INSERT OR REPLACE INTO product_i18n (product_id, lang, name, category_label, description, sizes, specs) VALUES ('stol-vertex-d90', 'en', 'Vertex D90 Table', 'Tables', 'Round 90 cm dining table Vertex featuring a white marble finish chipboard tabletop and robust metal base. For indoor and covered spaces. It is recommended to protect the chipboard tabletop from direct precipitation.', '["Ø90 × 75 см"]', '{"mat":"ЛДСП, металл","dim":"Ø90 × 75 см","maxLoad":"","colors":"White Marble"}');
...
INSERT OR REPLACE INTO product_i18n (product_id, lang, name, category_label, description, sizes, specs) VALUES ('stol-taper-rotang-135', 'ru', 'Стол «Taper Rotang 135x80»', 'Столы', 'Обеденный стол Taper Rotang размером 135×80 см. Каркас из металла с отделкой искусственным ротангом и столешница из ЛДСП. Для помещений и крытых пространств. Столешницу из ЛДСП рекомендуется защищать от прямых осадков.', '["135 × 80 × 75 см"]', '{"mat":"ЛДСП, металл, искусственный ротанг","dim":"135 × 80 × 75 см","maxLoad":"","colors":""}');
INSERT OR REPLACE INTO product_i18n (product_id, lang, name, category_label, description, sizes, specs) VALUES ('stol-taper-rotang-135', 'uz', '«Taper Rotang 135x80» stoli', 'Stollar', '135×80 sm o‘lchamdagi Taper Rotang ovqat stoli. Sun’iy rotangli metall karkas va LDSP ustki qism. Xonalar va yopiq maydonlar uchun. LDSP ustki qismini to‘g‘ridan-to‘g‘ri yog‘ingarchilikdan himoya qilish tavsiya etiladi.', '["135 × 80 × 75 см"]', '{"mat":"ЛДСП, металл, искусственный ротанг","dim":"135 × 80 × 75 см","maxLoad":"","colors":""}');
INSERT OR REPLACE INTO product_i18n (product_id, lang, name, category_label, description, sizes, specs) VALUES ('stol-taper-rotang-135', 'en', 'Taper Rotang 135x80 Table', 'Tables', 'Rectangular dining table Taper Rotang 135×80 cm. Metal frame accented with synthetic rattan weave and chipboard tabletop. For indoor and covered spaces. It is recommended to protect the chipboard tabletop from direct precipitation.', '["135 × 80 × 75 см"]', '{"mat":"ЛДСП, металл, искусственный ротанг","dim":"135 × 80 × 75 см","maxLoad":"","colors":""}');
...
INSERT OR REPLACE INTO product_i18n (product_id, lang, name, category_label, description, sizes, specs) VALUES ('stol-taper-80', 'ru', 'Стол «Taper 80x80»', 'Столы', 'Лаконичный стол Taper 80×80 см с металлической опорой и прочной столешницей из ЛДСП. Для помещений и крытых пространств. Столешницу из ЛДСП рекомендуется защищать от прямых осадков.', '["80 × 80 × 75 см"]', '{"mat":"ЛДСП, металл","dim":"80 × 80 × 75 см","maxLoad":"","colors":""}');
INSERT OR REPLACE INTO product_i18n (product_id, lang, name, category_label, description, sizes, specs) VALUES ('stol-taper-80', 'uz', '«Taper 80x80» stoli', 'Stollar', 'Metall tayanch va pishiq LDSP ustki qismga ega ixcham Taper 80×80 sm stoli. Xonalar va yopiq maydonlar uchun. LDSP ustki qismini to‘g‘ridan-to‘g‘ri yog‘ingarchilikdan himoya qilish tavsiya etiladi.', '["80 × 80 × 75 см"]', '{"mat":"ЛДСП, металл","dim":"80 × 80 × 75 см","maxLoad":"","colors":""}');
INSERT OR REPLACE INTO product_i18n (product_id, lang, name, category_label, description, sizes, specs) VALUES ('stol-taper-80', 'en', 'Taper 80x80 Table', 'Tables', 'Square dining table Taper 80×80 cm with sturdy metal support legs and chipboard top. For indoor and covered spaces. It is recommended to protect the chipboard tabletop from direct precipitation.', '["80 × 80 × 75 см"]', '{"mat":"ЛДСП, металл","dim":"80 × 80 × 75 см","maxLoad":"","colors":""}');
...
INSERT OR REPLACE INTO product_i18n (product_id, lang, name, category_label, description, sizes, specs) VALUES ('stol-vertex-80', 'ru', 'Стол «Vertex 80x80»', 'Столы', 'Квадратный стол Vertex 80×80 см со строгим геометрическим металлическим каркасом и столешницей из ЛДСП. Для помещений и крытых пространств. Столешницу из ЛДСП рекомендуется защищать от прямых осадков.', '["80 × 80 × 75 см"]', '{"mat":"ЛДСП, металл","dim":"80 × 80 × 75 см","maxLoad":"","colors":""}');
INSERT OR REPLACE INTO product_i18n (product_id, lang, name, category_label, description, sizes, specs) VALUES ('stol-vertex-80', 'uz', '«Vertex 80x80» stoli', 'Stollar', 'Aniq geometrik metall karkas va LDSP ustki qismli kvadrat Vertex 80×80 sm stoli. Xonalar va yopiq maydonlar uchun. LDSP ustki qismini to‘g‘ridan-to‘g‘ri yog‘ingarchilikdan himoya qilish tavsiya etiladi.', '["80 × 80 × 75 см"]', '{"mat":"ЛДСП, металл","dim":"80 × 80 × 75 см","maxLoad":"","colors":""}');
INSERT OR REPLACE INTO product_i18n (product_id, lang, name, category_label, description, sizes, specs) VALUES ('stol-vertex-80', 'en', 'Vertex 80x80 Table', 'Tables', 'Square table Vertex 80×80 cm with geometric metal frame and chipboard tabletop. For indoor and covered spaces. It is recommended to protect the chipboard tabletop from direct precipitation.', '["80 × 80 × 75 см"]', '{"mat":"ЛДСП, металл","dim":"80 × 80 × 75 см","maxLoad":"","colors":""}');
...
INSERT OR REPLACE INTO product_i18n (product_id, lang, name, category_label, description, sizes, specs) VALUES ('stol-taper-135', 'ru', 'Стол «Taper 135x80»', 'Столы', 'Просторный обеденный стол Taper 135×80 см. Каркас из металла и практичная столешница из ЛДСП для комфортного размещения 4–6 персон. Для помещений и крытых пространств. Столешницу из ЛДСП рекомендуется защищать от прямых осадков.', '["135 × 80 × 75 см"]', '{"mat":"ЛДСП, металл","dim":"135 × 80 × 75 см","maxLoad":"","colors":""}');
INSERT OR REPLACE INTO product_i18n (product_id, lang, name, category_label, description, sizes, specs) VALUES ('stol-taper-135', 'uz', '«Taper 135x80» stoli', 'Stollar', 'Keng Taper 135×80 sm ovqat stoli. 4-6 kishi uchun qulay o‘tirishni ta’minlovchi metall karkas va amaliy LDSP ustki qism. Xonalar va yopiq maydonlar uchun. LDSP ustki qismini to‘g‘ridan-to‘g‘ri yog‘ingarchilikdan himoya qilish tavsiya etiladi.', '["135 × 80 × 75 см"]', '{"mat":"ЛДСП, металл","dim":"135 × 80 × 75 см","maxLoad":"","colors":""}');
INSERT OR REPLACE INTO product_i18n (product_id, lang, name, category_label, description, sizes, specs) VALUES ('stol-taper-135', 'en', 'Taper 135x80 Table', 'Tables', 'Spacious dining table Taper 135×80 cm. Metal frame and practical chipboard tabletop comfortably seating 4 to 6 people. For indoor and covered spaces. It is recommended to protect the chipboard tabletop from direct precipitation.', '["135 × 80 × 75 см"]', '{"mat":"ЛДСП, металл","dim":"135 × 80 × 75 см","maxLoad":"","colors":""}');
...
INSERT OR REPLACE INTO product_i18n (product_id, lang, name, category_label, description, sizes, specs) VALUES ('stol-corda-135', 'ru', 'Стол «Corda 135x80»', 'Столы', 'Обеденный стол Corda 135×80 см. Надежная металлическая база и износостойкая столешница из ЛДСП. Для помещений и крытых пространств. Столешницу из ЛДСП рекомендуется защищать от прямых осадков.', '["135 × 80 × 75 см"]', '{"mat":"ЛДСП, металл","dim":"135 × 80 × 75 см","maxLoad":"","colors":""}');
INSERT OR REPLACE INTO product_i18n (product_id, lang, name, category_label, description, sizes, specs) VALUES ('stol-corda-135', 'uz', '«Corda 135x80» stoli', 'Stollar', 'Corda 135×80 sm ovqat stoli. Ishonchli metall baza va pishiq LDSP ustki qismi. Xonalar va yopiq maydonlar uchun. LDSP ustki qismini to‘g‘ridan-to‘g‘ri yog‘ingarchilikdan himoya qilish tavsiya etiladi.', '["135 × 80 × 75 см"]', '{"mat":"ЛДСП, металл","dim":"135 × 80 × 75 см","maxLoad":"","colors":""}');
INSERT OR REPLACE INTO product_i18n (product_id, lang, name, category_label, description, sizes, specs) VALUES ('stol-corda-135', 'en', 'Corda 135x80 Table', 'Tables', 'Dining table Corda 135×80 cm. Solid metal base paired with a resilient chipboard top. For indoor and covered spaces. It is recommended to protect the chipboard tabletop from direct precipitation.', '["135 × 80 × 75 см"]', '{"mat":"ЛДСП, металл","dim":"135 × 80 × 75 см","maxLoad":"","colors":""}');
