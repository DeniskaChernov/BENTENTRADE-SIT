...
**Обязательное поле при регистрации — только `phone`.** Email и пароль — опционально (или вход по SMS-коду на этапе 2).
...
Валидация: `phone` обязателен (мин. 7 цифр). Email не запрашивается.

После успеха на сайте:

1. Создать сессию по `phone`.
...
- [ ] Вход по SMS-коду (этап 2) или пока без пароля вообще?
...
*Документ версии 1.1 — 2026-07-10. Согласовано: 2 БД, webhooks, скрытая атрибуция дилера, регистрация по телефону.*
